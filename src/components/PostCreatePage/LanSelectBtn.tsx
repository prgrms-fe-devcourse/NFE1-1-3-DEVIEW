...
export const LanSelectBtn = ({ value, onChange }: LanSelectBtnProps) => {
  return (
    <select
      value={value || "default"}
      className="h-12 w-[20%] min-w-24 rounded-lg border border-secondary text-center text-14 font-medium leading-none text-secondary focus:outline-none focus:ring-0 md:h-auto"
      onChange={onChange}
    >
